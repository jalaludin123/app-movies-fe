...
<template>
    <!-- Navbar Start -->
    <div class="mx-auto px-5 bg-black">
        <header class="flex justify-between items-center">
            <div v-if="userToken !== null">
                <div v-if="userRole === 'customer'">
                    <RouterLink to="/customer"><img src="/images/ipsum4.png" alt="Site Logo"></RouterLink>
                </div>
                <div v-else>
                    <RouterLink to="/admin"><img src="/images/ipsum4.png" alt="Site Logo"></RouterLink>
                </div>
            </div>
            <div v-else>
                <RouterLink to="/"><img src="/images/ipsum4.png" alt="Site Logo"></RouterLink>
            </div>
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <!-- Desktop Menu -->
                <div v-if="userToken !== null">
                    <ul class="text-white space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                        <li v-if="userRole === 'customer'" class="uppercase hover:text-white transition duration-200"><RouterLink to="/my-list-rental" v-smooth-scroll>My List Rental</RouterLink></li>
                        <li class="uppercase bg-theme-secondary px-6 py-2 text-white rounded shadow-md hover:bg-white border-2 border-transparent hover:border-theme-secondary hover:text-theme-secondary cursor-pointer transition duration-200">
                            <button @click="logout" to="/logout" v-smooth-scroll>Logout</button>
                        </li>
                    </ul>
                </div>
                <div v-else>
                    <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                        <li class="uppercase bg-indigo-600 px-6 py-2 text-white rounded shadow-md hover:bg-white border-2 border-transparent hover:border-theme-secondary hover:text-theme-secondary cursor-pointer transition duration-200">
                            <RouterLink to="/login" v-smooth-scroll>Login</RouterLink>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div v-show="mobileNav">
            <div class="absolute px-5 py-12 block z-30 top-0 left-0 w-full h-full bg-gradient-to-b from-theme-dark-blue via-theme-dark-blue-tp to-theme-dark-blue">
                <div class="flex justify-between items-center">
                    <img src="/images/ipsum4.png" alt="Logo">
                ...
                <div v-if="userToken !== null">
                    <ul class="uppercase text-white text-md tracking-widest items-center flex flex-col mt-14">
                        <li class="hover:text-theme-secondary transition duration-200 py-4 border-t border-b border-theme-grayish-blue w-full text-center">
                            <a  @click="toggleMobileNav()" href="#koleksi-section">Koleksi</a>
                        </li>
                ...
                <div v-else>
                    <ul class="uppercase text-white text-md tracking-widest items-center flex flex-col mt-14">
                        <li class="bg-transparent border-2 rounded px-6 py-2 mt-6 w-full text-center cursor-pointer hover:text-theme-secondary transition duration-200">
                            <a  @click="toggleMobileNav()" href="#download-section">Login</a>
                        </li>
                    </ul>
                </div>
    ...
    export default {
        methods: {
            logout() {
                ...
                this.$router.push('/login'); // Assuming your login route is named 'login'
            }
        }
    };
</script>