...
<div class="container mx-auto px-5 py-12 md:w-4/5">
  <form @submit.prevent="CreateMovie" class="space-y-8 divide-y divide-gray-200">
        <div class="space-y-6 sm:pt-10 sm:space-y-5">
            <div>
                <h2 class="text-3xl md:text-4xl font-theme-heading font-medium text-center mb-3">Create Movie</h2>
            </div>
